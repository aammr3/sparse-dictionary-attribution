"""Generate exp5/exp5_kaggle.ipynb from exp5/exp5_source.py.
...
SRC = os.path.normpath(os.path.join(HERE, "exp5_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp5_kaggle.ipynb"))
