"""Generate exp3/exp3_kaggle.ipynb from exp3/exp3_source.py.
...
SRC = os.path.normpath(os.path.join(HERE, "exp3_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp3_kaggle.ipynb"))
