"""Generate exp3b/exp3b_kaggle.ipynb from exp3b/exp3b_source.py.
...
exp2/exp2f_kaggle.ipynb (the most recent self-generated notebook in this
project) and the older hand-built exp0/exp0d_kaggle.ipynb and
exp1/exp1h_kaggle.ipynb.
...
SRC = os.path.normpath(os.path.join(HERE, "exp3b_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp3b_kaggle.ipynb"))
