"""Generate exp2/exp2d_kaggle.ipynb from exp2/exp2d_source.py.
...
SRC = os.path.normpath(os.path.join(HERE, "exp2d_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp2d_kaggle.ipynb"))
