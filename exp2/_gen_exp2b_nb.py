"""Generate exp2/exp2b_kaggle.ipynb from exp2/exp2b_source.py.
...
SRC = os.path.normpath(os.path.join(HERE, "exp2b_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp2b_kaggle.ipynb"))
