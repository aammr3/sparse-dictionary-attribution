"""Generate exp2/exp2e_kaggle.ipynb from exp2/exp2e_source.py.
...
exp2/exp2c_kaggle.ipynb and exp2/exp2d_kaggle.ipynb.
...
SRC = os.path.normpath(os.path.join(HERE, "exp2e_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp2e_kaggle.ipynb"))
