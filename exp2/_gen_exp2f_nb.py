"""Generate exp2/exp2f_kaggle.ipynb from exp2/exp2f_source.py.
...
exp2/exp2_kaggle.ipynb and exp2/exp2b_kaggle.ipynb and
exp2/exp2c_kaggle.ipynb and exp2/exp2d_kaggle.ipynb and
exp2/exp2e_kaggle.ipynb.
...
SRC = os.path.normpath(os.path.join(HERE, "exp2f_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp2f_kaggle.ipynb"))
