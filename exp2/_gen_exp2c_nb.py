"""Generate exp2/exp2c_kaggle.ipynb from exp2/exp2c_source.py.
...
exp2/exp2_kaggle.ipynb and exp2/exp2b_kaggle.ipynb.
...
SRC = os.path.normpath(os.path.join(HERE, "exp2c_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp2c_kaggle.ipynb"))
