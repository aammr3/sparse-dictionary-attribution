"""Generate exp4b/exp4b_kaggle.ipynb from exp4b/exp4b_source.py.
...
exp4/exp4_kaggle.ipynb and the older self-generated notebooks in
this project.
...
SRC = os.path.normpath(os.path.join(HERE, "exp4b_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp4b_kaggle.ipynb"))
