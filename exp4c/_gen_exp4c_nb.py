"""Generate exp4c/exp4c_kaggle.ipynb from exp4c/exp4c_source.py.
...
exp4/exp4_kaggle.ipynb and exp4b/exp4b_kaggle.ipynb.
...
SRC = os.path.normpath(os.path.join(HERE, "exp4c_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp4c_kaggle.ipynb"))
