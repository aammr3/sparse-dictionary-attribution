"""Generate exp9/exp9_kaggle.ipynb from exp9/exp9_source.py.
...
SRC = os.path.normpath(os.path.join(HERE, "exp9_source.py"))
DST = os.path.normpath(os.path.join(HERE, "exp9_kaggle.ipynb"))
